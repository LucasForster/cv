...
\cvachievement{\faJs}{TypeScript with newest ECMAScript features}%
...
\smallskip
\cvachievement{\faNode}{Node.js (Deno when suitable)}%
    {Sharing code in monorepos to avoid discrepancies.}
\smallskip
\cvachievement{\faDatabase}{PostgreSQL (or non-relational cloud offerings)}%
